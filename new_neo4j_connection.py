...
csv_files = {
    ...
    "papers_with_acceptance.csv": ("Paper", "paperId"),
    "accepted_venues.csv": ("Venue", "venueId"),
}
...
with open(os.path.join(folder_path, "papers_with_acceptance.csv"), "r", encoding="utf-8") as papers_file:
...
with open(os.path.join(folder_path, "papers_with_acceptance.csv"), "r", encoding="utf-8") as f:
    reader = csv.DictReader(f)
    for row in reader:
